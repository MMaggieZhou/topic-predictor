...
classlabel="/Users/mengqizhou/Desktop/datamining/programing3/data/initialdata/binary_class_labels.csv"
...
bcl = genfromtxt(classlabel, dtype=int,delimiter = ',')   
bcl = np.array(bcl)
...
for metric in (0,1):
    for method in (0,1):
        ...
        for i in range(0,len(vnocfile)):
            ...
            print str(len(vnoc))+"clusters,entropy= "+str(entropy.calculate_overall_entropy(vnoc, bcl, nvoc))
